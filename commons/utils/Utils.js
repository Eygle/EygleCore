...
var Utils = (function () {
     ...
     * @return {boolean}
     */
    Utils.isMongoId = function (value) {
     ...
     * @return {boolean}
     */
    Utils.compareIds = function (obj1, obj2) {
        if (this.isString(obj2)) {
            return this.isString(obj1) ? obj1 === obj2 : this.hasId(obj1) && obj1._id.toString() === obj2;
        }
        if (this.isString(obj1)) {
            return this.isString(obj2) ? obj1 === obj2 : this.hasId(obj2) && obj2._id.toString() === obj1;
        }
        return this.hasId(obj1) && this.hasId(obj2) && obj1._id.toString() === obj2._id.toString();
    };
    /**
    ...
    Utils.formatDuration = function (ms) {
        var duration = parseInt((ms / 1000), 10);
     ...
     * @param {string} idx
     */
    Utils.forEachNewObject = function (oArr, nArr, callback, idx) {
        var _this = this;
        if (idx === void 0) { idx = '_id'; }
        if (!oArr || !nArr)
            return;
        var _loop_1 = function (item) {
            if (!_.find(oArr, function (i) {
                if (idx === '_id') {
                    return _this.compareIds(i, item);
                }
                else if (idx) {
     ...
     * @return {EEnv}
     */
    Utils.getEnvFromName = function (envName) {
        switch (envName) {
            case 'development':
                return core_enums_1.EEnv.Dev;
            case 'test':
                return core_enums_1.EEnv.Test;
            case 'preprod':
     ...
     * TMDB Api token
     */
    Utils.tmdbToken = '22e2817ba73ca94f0b3971f847acefc6';
    /**
     * TVDB Api token
     */
    Utils.tvdbToken = '72FB8B2E308C7EE1';
    /**
     * Map all accents to base letters
     * @private
     */
    Utils._defaultDiacriticsRemovalMap = [
        {
            'base': 'A',
