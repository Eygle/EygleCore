...
class Utils {
    ...
    static formatDuration(ms) {
        const duration = parseInt((ms / 1000), 10);
     ...
     * @param {string} idx
     */
    static forEachNewObject(oArr, nArr, callback, idx = '_id') {
        if (!oArr || !nArr)
            return;
